  ...
  <nav class="navbar navbar-expand-lg bg-light">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0" v-if="store.state.user.logged">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li v-if="isAdmin">
                <router-link class="dropdown-item" to="/activeUsers" active-class="active">
                  List of registered users
                </router-link>
              </li>
              <li v-if="isAdmin">
                <router-link class="dropdown-item" to="/cat" active-class="active">
                  List of categories
                </router-link>
              </li>
            </ul>
        ...
        <span v-if="store.state.user.logged"> Authenticate as {{ store.state.user.login }} </span>
        <ul class="navbar-nav">
